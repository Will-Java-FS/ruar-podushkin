...
public class AccountControllerTEST
{
    ...
    public void getAccountById_SuccessfulTEST() throws Exception
    {
        ...
        Account account = new Account(1, "username", "password", "email", null);
    ...
    {
        // Create mock data
        Account accountToAdd = new Account(1, "username", "password", "email", null);
        Account accountAdded = new Account(1, "username", "password", "email", null);
